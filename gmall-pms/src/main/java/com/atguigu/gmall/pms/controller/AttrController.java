...
public class AttrController {
    ...
    @GetMapping
    public Resp<PageVo> queryAttrByCid(QueryCondition condition,
                                       @RequestParam(value = "cid")Long cid,
                                       @RequestParam(value = "type", required = false)Integer type){
        PageVo pageVo = this.attrService.queryAttrByCid(condition, cid, type);
    ...
    public Resp<Object> save(@RequestBody AttrVO attr){
        ...
        this.attrService.saveAttrWithRelation(attr);
